...
The generated board embeds deterministic connector geometry while retaining the corresponding standard KiCad footprint library IDs. KiCad therefore reports two non-fatal library-shape comparison warnings; these do not change the 2.54 mm pad pattern, pad numbering, drill sizes, connector side, or copper connectivity.
